...
const MyTaskDetails = () => {
  ...
  useEffect(() => {
    const fetchTask = async () => {
      try {
        ...
        const res = await axios.get(`http://127.0.0.1:8000/api/my-tasks/${id}`, {
  ...
  const handleUpdate = async () => {
    try {
      setLoading(true);
      const token = localStorage.getItem('token');
      await axios.put(`http://127.0.0.1:8000/api/my-tasks/${id}`, {
        ...task,
  ...
  const handleDelete = () => {
    swal({
      ...
      if (willDelete) {
        try {
          const token = localStorage.getItem('token');
          await axios.delete(`http://127.0.0.1:8000/api/my-tasks/${id}`, {
            headers: { Authorization: `Bearer ${token}` },
          });
    ...
    <UserLayout>
      <div className="task-details-container">
        <div className="task-details-header">
          <button className="back-button" onClick={() => navigate('/my-tasks')}>
            &larr; Back to Tasks
          </button>
              ...
              <div className="task-body">
                ...
                <div className="task-info-grid">
                  ...
                  <div className="info-item">
                    ...
                    <div className="info-value">{task.assigned_to?.name || "Unassigned"}</div>
                  </div>
